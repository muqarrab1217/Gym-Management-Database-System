...
{
    public partial class TRAINER_YourDietPlan : Form
    {
        int trainerid;
        ...
        private void days_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {

        }

        private void objective_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                string insertDietPlanQuery = "INSERT INTO DietPlan (DietID, TrainerID, Objective, Type, Number_of_days) " +
                    "VALUES (@DietID, @TrainerID, @Objective, @Type, @Number_of_days)";
                ...
                insertDietPlanCommand.Parameters.AddWithValue("@TrainerID", trainerID);
                ...
                string insertMealContainsQuery = "INSERT INTO Meal_Contains (DietID, MealID) " +
                    "VALUES (@DietID, @MealID)";
