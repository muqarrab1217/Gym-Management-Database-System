...
{
    public partial class MEMBER_memberForm : Form
    {
        bool sidebarExpand;
        ...
        public MEMBER_memberForm()
        {
            InitializeComponent();
            loadForm(new MEMBER_dashboard());
        }
        ...
        {
            loadForm(new MEMBER_WorkoutPlan());
        }

        private void gymButton_Click(object sender, EventArgs e)
        {
            loadForm(new MEMBER_Appointments());
        }
